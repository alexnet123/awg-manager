...
- [docs/operations/STAND_SETUP_FIXES.md](docs/operations/STAND_SETUP_FIXES.md) (stand setup issues and fixes log)
...
- [docs/testing/TESTS_CATALOG.ru.md](docs/testing/TESTS_CATALOG.ru.md) (complete tests catalog, RU)
