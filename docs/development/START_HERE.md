...
- New logic goes to `backend/common` or `backend/domains/*`, not to `awg_core.py`.
...
4. Verification commands executed:
   ...
   - If `awg_core.py` or `backend/app/manager_facade.py` changed:
